    ...
    <div class="flex items-center justify-center min-h-screen overflow-hidden">
      <div class="flex flex-col items-center justify-center">
        <svg width="54" height="40" viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="mb-8 w-32 shrink-0">
          <!-- Skratio SVG radi čitljivosti -->
          <circle cx="27" cy="20" r="18" fill="var(--primary-color)" />
          <text x="27" y="25" font-size="12" text-anchor="middle" fill="white">404</text>
        </svg>
        ...
        >
          <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
            ...
            <button pButton type="button" class="p-button p-component" routerLink="/">
              Go to Dashboard
            </button>
          </div>
        </div>
